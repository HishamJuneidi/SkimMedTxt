...
class SkimMedText:
  ...
  def train(self):
    ...
    model_1_history = model_1.fit(train_dataset,
                                  steps_per_epoch=int(0.01 * len(train_dataset)), # only fit on 10% of batches for faster training time
                                  epochs=1,
                                  validation_data=valid_dataset,
                                  validation_steps=int(0.01 * len(valid_dataset))
                                  ) 
